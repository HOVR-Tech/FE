    ...
    <>
      <div className="">
        <div>
          ...
          <div style={{ marginTop: '2rem', marginLeft: '8rem', justifyContent: 'center', alignItems: 'center' }}>
            <p style={{ color: 'white', fontSize: '20px', fontWeight: 150 }}>Find Great Places For Vacation</p>
            <InputGroup
              className="mb-3"
              style={{
                width: '77vw',
            ...
            >
              <Form.Control placeholder="Search Here ..." aria-label="Search" aria-describedby="basic-addon2" />
        ...
        >
          <Card style={{ width: '12rem', height: '18rem', marginLeft: '3rem', paddingBottom: '25px' }}>
            <Card.Img className="mx-auto mt-5 mb-2" variant="top" src={ContentIcon1} style={{ width: '3rem' }} />
            <Card.Body>
          ...
          <Card style={{ width: '12rem', height: '18rem', marginLeft: '3rem', paddingBottom: '25px' }}>
            <Card.Img className="mx-auto mt-5 mb-2" variant="top" src={ContentIcon2} style={{ width: '3rem' }} />
            <Card.Body>
          ...
          <Card style={{ width: '12rem', height: '18rem', marginLeft: '3rem', paddingBottom: '25px' }}>
            <Card.Img className="mx-auto mt-5 mb-2" variant="top" src={ContentIcon3} style={{ width: '3rem' }} />
            <Card.Body>
          ...
          <Card style={{ width: '12rem', height: '18rem', marginLeft: '3rem', paddingBottom: '25px' }}>
            <Card.Img className="mx-auto mt-5 mb-2" variant="top" src={ContentIcon4} style={{ width: '3rem' }} />
            <Card.Body>
